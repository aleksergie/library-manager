      ...
      <form [formGroup]="form" (ngSubmit)="onSubmit()">
        <div class="form-group">
          ...
          @if (form.get('title')?.touched && form.get('title')?.invalid) {
            <div class="error">Title is required (max 500 chars).</div>
          }
        </div>
        ...
        <div class="form-group">
          ...
          @if (form.get('author')?.touched && form.get('author')?.invalid) {
            <div class="error">Author is required (max 200 chars).</div>
          }
        </div>
        ...
        <div class="form-group">
          ...
          @if (form.get('pages')?.touched && form.get('pages')?.invalid) {
            <div class="error">Pages must be between 1 and 100,000.</div>
          }
        </div>
